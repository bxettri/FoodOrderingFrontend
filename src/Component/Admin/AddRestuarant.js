          ...
          <h2 style={{color:'Crimson'}}>Add Resturant</h2><hr/>
              <form style={{backgroundColor:'AntiqueWhite'}}>
                <FormGroup>
                  ...
                  <Input type='text' id="resturantname" placeholder="restaurant" name='resturant_name' value={this.state.resturant_name}
                    onChange={this.handleChange}/>
                </FormGroup>
                <FormGroup>
                  <Label for='resturant_address'>Resturant_address</Label>
                  <Input type='text' id='resturant_address' placeholder="address" name='resturant_address' value={this.state.resturant_address}
                    onChange={ this.handleChange} />
                    </FormGroup>
                  <FormGroup>
