      ...
      <div id="viewCartDiv">
        ...
        <Modal isOpen={this.state.modal}>
          ...
          <ModalBody>
            ...
            <textarea id="notes" name="notes" value={this.state.viewfood.notes} onChange={this.handleChange}></textarea>
            <hr/>
            <input type="number" pattern="[0-9]*" name="quanity" value={this.state.viewfood.quanity} onChange={this.handleChange} min="1" max="100" />
          </ModalBody>
          <ModalFooter>
